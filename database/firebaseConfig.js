...
// Exposed so db.js can use static helpers like FieldValue.increment(),
// which live on the module itself rather than on the db() instance.
export const firestoreStatic = firestore;
